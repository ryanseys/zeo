...
Suite `rubyspec` — **3/67 passing (4.5%)** — oracle `ruby 4.0.5 (2026-05-20 revision 64336ffd0e) +PRISM [arm64-darwin25]` — spinel-rs `d93b6b8`
...
|---|---|---|---|
| 33 | spike-misc | ? | and_spec |
| 4 | singleton-class | d | alias_spec |
