...
Suite `spinel` — **2277/2341 passing (97.3%)** — oracle `ruby 4.0.5 (2026-05-20 revision 64336ffd0e) +PRISM [arm64-darwin25] [--disable-error_highlight --disable-did_you_mean]` — zeo `3e7dffe`
...
|---|---|---|---|---|
| 2 | auto-from-users-ryanseys-dev-zeo-crates-xtask-conformance-a2be | ? | issue_3216 | from /Users/ryanseys/dev/zeo/crates/xtask/../../conformance/corpus/test/issue_3216.rb:10:in '<main>' |
...
| 1 | auto-from-users-ryanseys-dev-zeo-crates-xtask-conformance-26e1 | ? | param_body_hash_inference | from /Users/ryanseys/dev/zeo/crates/xtask/../../conformance/corpus/test/param_body_hash_inference.rb:51:in '<main>' |
