...
|---|---|---|---|---|
| g | arity-panic | 33 | data_with_unknown_kw, str_method_nil_arg_no_segv, bundle_tiny_string | uncaught exception: wrong number of arguments (given 2, expected 0) |
| ? | spike-misc | 30 | valued_break_proc, exception_value_parity, public_send_visibility | a lambda escaping from inside another escaping block isn't supported yet (spike scope) |
...
| P | missing-const:Random | 8 | issue_2869, random_float_seed, random_rand_argument | uncaught exception: uninitialized constant Random |
...
| P | missing-method:[] | 7 | hash_empty_literal_and_map, hash_variant_returns, param_body_hash_inference | uncaught exception: undefined method '[]' for class Hash |
...
| P | missing-method:value | 5 | thread_preempt, thread_value_through_container, proc_concurrent_call_poly_ret | uncaught exception: undefined method 'value' for an instance of Thread |
...
| P | missing-method:join | 4 | thread_mutex, index_opassign_in_thread_block, lifted_block_nested_capture | uncaught exception: undefined method 'join' for an instance of Thread |
...
| P | missing-method:current | 3 | fiber_transfer_root, thread_local, fiber_class_reflection | uncaught exception: undefined method 'current' for class Fiber |
...
| P | missing-method:include? | 3 | module_include_p, param_include_body_widen, module_constants_included_modules | uncaught exception: undefined method 'include?' for class Dog |
...
| ! | rustc-failure | 3 | proc_block_param_call, exception_object_surface, new_forwarded_block_stored | rustc failed compiling the generated program (source at /var/folders/7r/0kdzlwm12_19f3qc1j8w5vjr0000gn/T/spinelc-gen-ed80ce2614a18b4e.rs) |
...
| ? | auto-5acee2ea | 2 | matchdata_value_varargs_symstr, string_search_slice | uncaught exception: no implicit conversion of Regexp into String |
...
| P | missing-method:catch | 2 | bundle_misc_a, proc_return_catch_no_leak | uncaught exception: undefined method 'catch' for an instance of Object |
...
| P | missing-method:last_match | 2 | regexp_reflection, regexp_last_match_capture | uncaught exception: undefined method 'last_match' for class Regexp |
...
| P | missing-method:polar | 2 | complex_polar, complex_component_class | uncaught exception: undefined method 'polar' for class Complex |
...
| P | missing-method:report_on_exception= | 2 | thread_kill_raise, thread_raise_main | uncaught exception: undefined method 'report_on_exception=' for class Thread |
| P | missing-method:sleep | 2 | bundle_class_23, sleep_return_value | uncaught exception: undefined method 'sleep' for module Kernel |
...
| P | missing-method:sqrt | 2 | integer_bignum_batch2, bundle_integer | uncaught exception: undefined method 'sqrt' for class Integer |
| P | missing-method:try_convert | 2 | array_conformance_batch, hash_array_string_batch8 | uncaught exception: undefined method 'try_convert' for class Array |
...
| P | missing-method:alive? | 1 | thread_basic | uncaught exception: undefined method 'alive?' for an instance of Thread |
