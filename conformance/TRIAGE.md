...
|---|---|---|---|---|
| P | missing-builtin-method | 208 | array_conformance_batch | uncaught exception: undefined method 'rfind' for an instance of Array |
| ? | spike-misc | 40 | array_bsearch_find_any | uncaught exception: Array#bsearch's find-any mode (a numeric block result) isn't supported yet (spike scope) |
| g | arity-panic | 28 | bundle_string_c | uncaught exception: wrong number of arguments (given 2, expected 1) |
