...
|---|---|---|---|---|
| ? | spike-misc | 33 | and_spec | spinelc: /Users/ryanseys/dev/spec/language/and_spec.rb: empty parentheses `()` aren't supported yet (spike scope) |
| d | singleton-class | 4 | alias_spec | spinelc: /Users/ryanseys/dev/spec/language/alias_spec.rb: unsupported syntax at "class << @obj;self;end" (spike handles only what the 7 example programs need) |
...
| a | splat | 1 | for_spec | spinelc: /Users/ryanseys/dev/spec/language/for_spec.rb: expected `*name` as a multi-assignment's splat target |
