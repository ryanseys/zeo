...
//! - the source is valid Ruby that spinel does not lower yet, which is a
//!   `NotImplementedError`
//!
...
//! has to raise one or the other, and reporting a spinel scope limitation as a
...
mod classification_tests {
    ...
    /// spinel hasn't implemented is spinel's `NotImplementedError`. Reporting
