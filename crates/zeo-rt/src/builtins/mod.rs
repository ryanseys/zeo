...
pub(crate) fn class_table(id: ClassId) -> Option<fn(&str) -> Option<BuiltinMethodFn>> {
    Some(match id {
        ...
        zeo_abi::PROCESS_TMS_CLASS => process::lookup_tms,
...
pub(crate) fn class_arity_table(id: ClassId) -> Option<fn(&str) -> Option<i64>> {
    Some(match id {
        ...
        zeo_abi::PROCESS_TMS_CLASS => process::lookup_tms_arity,
...
pub(crate) fn class_method_table(id: ClassId) -> Option<fn(&str) -> Option<BuiltinMethodFn>> {
    Some(match id {
        ...
        zeo_abi::PROC_CLASS => rproc::lookup_class,
        zeo_abi::REGEXP_CLASS => regexp::lookup_class,
        ...
        zeo_abi::MARSHAL_MODULE => marshal::lookup_class,
        zeo_abi::ENUMERATOR_CLASS => enumerator::lookup_class,
        zeo_abi::CONDITION_VARIABLE_CLASS => condition_variable::lookup_class,
...
pub(crate) fn class_table_names(id: ClassId) -> &'static [&'static str] {
    match id {
        ...
        zeo_abi::PROCESS_TMS_CLASS => process::lookup_tms_names(),
...
pub(crate) fn class_method_table_names(id: ClassId) -> &'static [&'static str] {
    match id {
        ...
        zeo_abi::PROC_CLASS => rproc::lookup_class_names(),
        zeo_abi::REGEXP_CLASS => regexp::lookup_class_names(),
        ...
        zeo_abi::MARSHAL_MODULE => marshal::lookup_class_names(),
        zeo_abi::ENUMERATOR_CLASS => enumerator::lookup_class_names(),
        zeo_abi::CONDITION_VARIABLE_CLASS => condition_variable::lookup_class_names(),
