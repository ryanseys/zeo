...
capi_symbols!(
    ...
    dispatch::zeo_rt_callsites_init,
    ...
    ffi::zeo_rt_ffi_after_call,
    ffi::zeo_rt_ffi_enum_field,
    ffi::zeo_rt_ffi_enum_store,
    ffi::zeo_rt_ffi_from_cstr,
    ffi::zeo_rt_ffi_from_ptr,
    ffi::zeo_rt_ffi_from_uint,
    ffi::zeo_rt_ffi_invoke,
    ffi::zeo_rt_ffi_lib_store,
    ffi::zeo_rt_ffi_sym,
    ffi::zeo_rt_ffi_sym_slot,
    ffi::zeo_rt_ffi_to_f64,
    ffi::zeo_rt_ffi_to_int,
    ffi::zeo_rt_ffi_to_ptr,
    ...
    dispatch::zeo_rt_native_row_exists,
