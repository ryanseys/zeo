...
pub fn from_immediate(v: Value) -> Option<RubyValue> {
    Some(match v {
        ...
        _ if is_static_symbol(v) => {
            RubyValue::Symbol(zeo_rt::Symbol::from_u32(static_symbol_id(v)))
        }
        _ => return None,
    })
}
...
mod tests {
    ...
    fn an_identity_value_asks_for_a_handle() {
        ...
        let s = zeo_rt::builtins::string::str_value_in_enc(zeo_rt::encoding::UTF_8, "x");
