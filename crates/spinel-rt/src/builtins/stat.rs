...
use crate::Signal;
use spinel_abi::{ClassId, FILE_STAT_CLASS};
...
builtin_methods! {
    ...
    "inspect" | "to_s" => fn st_inspect(recv, args, _blk) {
        arity!(args, 0);
        let st = &recv_stat(recv)?.st;
