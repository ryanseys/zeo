...
pub(crate) fn class_table(id: ClassId) -> Option<fn(&str) -> Option<BuiltinMethodFn>> {
    Some(match id {
        ...
        spinel_abi::PROCESS_STATUS_CLASS => process::lookup_status,
        spinel_abi::PROCESS_TMS_CLASS => process::lookup_tms,
...
pub(crate) fn class_arity_table(id: ClassId) -> Option<fn(&str) -> Option<i64>> {
    Some(match id {
        ...
        spinel_abi::PROCESS_TMS_CLASS => process::lookup_tms_arity,
...
pub(crate) fn class_table_names(id: ClassId) -> &'static [&'static str] {
    match id {
        ...
        spinel_abi::PROCESS_STATUS_CLASS => process::lookup_status_names(),
        spinel_abi::PROCESS_TMS_CLASS => process::lookup_tms_names(),
