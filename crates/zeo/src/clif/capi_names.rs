...
pub const CAPI: &[CapiSig] = &[
    ...
    CapiSig {
        name: "zeo_rt_attr_read",
        params: &[Ptr, U32, Usize, U32, U32, Ptr],
        ret: Some(I32),
    },
    CapiSig {
        name: "zeo_rt_attr_write",
        params: &[Ptr, U32, Usize, U32, U32, Ptr, Ptr],
        ret: Some(I32),
    },
    CapiSig {
        name: "zeo_rt_autoload_pending",
    ...
    CapiSig {
        name: "zeo_rt_autoload_touch_value",
    ...
    CapiSig {
        name: "zeo_rt_eval_class_open",
        params: &[Ptr, Ptr, Ptr, Ptr, U8, Ptr],
        ret: Some(I32),
    },
    CapiSig {
        name: "zeo_rt_eval_define",
        params: &[U8, Ptr, U32, Ptr, U8, Ptr],
        ret: Some(I32),
    },
    CapiSig {
        name: "zeo_rt_eval_definee",
        params: &[U8, Ptr, Ptr],
        ret: Some(I32),
    },
    CapiSig {
    ...
    CapiSig {
        name: "zeo_rt_eval_refined_send_args",
        params: &[U32, Ptr, U32, Ptr, U8, Ptr, Ptr, Ptr, Usize, U8, Ptr],
        ret: Some(I32),
    },
    CapiSig {
    ...
    CapiSig {
        name: "zeo_rt_refined_send_args_in",
        params: &[U32, Ptr, U32, Ptr, U8, Ptr, Ptr, Ptr, Usize, U8, Ptr],
        ret: Some(I32),
    },
    CapiSig {
    ...
    CapiSig {
        name: "zeo_rt_using_slots_ensure",
        params: &[U32],
        ret: None,
    },
    CapiSig {
