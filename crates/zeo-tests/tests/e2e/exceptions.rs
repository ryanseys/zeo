...
fn case_in_with_no_matching_arm_and_no_else_raises() {
    ...
    assert!(
        result
            ...
            .contains("in '<main>': 5: String === 5 does not return true (NoMatchingPatternError)"),
        "stderr: {}",
        result.stderr
    );
}
...
#[test]
fn aliasing_a_genuinely_undefined_method_is_a_runtime_name_error() {
...
#[test]
fn frozen_and_arg_validation_guards() {
...
#[test]
fn frozen_class_and_object_mutation_guards_raise_cruby_frozen_errors() {
