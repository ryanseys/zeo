...
# 
# The `a cycle with the limit off` row builds `a << a`, which is that row's whole subject.
...
__END__
at the ceiling	Array
past it	Array
far past it	Array
parse! past it	Array
in a thread	Array
in a fiber	Array
generate past it	4202
a cycle with the limit off	JSON::NestingError
just under	1
the gem's own default still applies	JSON::NestingError
