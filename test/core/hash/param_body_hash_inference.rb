...
__END__
#@ stderr
core/hash/param_body_hash_inference.rb:43:in 'Object#consume': undefined method '[]' for nil (NoMethodError)
	from core/hash/param_body_hash_inference.rb:51:in '<main>'
#@ exit 1
