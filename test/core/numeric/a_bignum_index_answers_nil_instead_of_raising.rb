...
p [1, 2].values_at(B)
__END__
[:ary, RangeError, "bignum too big to convert into 'long'"]
[:str, RangeError, "bignum too big to convert into 'long'"]
#@ stderr
core/numeric/a_bignum_index_answers_nil_instead_of_raising.rb:34:in '<main>': bignum too big to convert into 'long' (RangeError)
#@ exit 1
