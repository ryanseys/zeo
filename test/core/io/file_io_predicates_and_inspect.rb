...
p File.readable_real?("no_such_probe_file_xyz")
p File.writable_real?("no_such_probe_file_xyz")
p File.executable_real?("no_such_probe_file_xyz")
p File.readable?(path)
p File.readable?("no_such_probe_file_xyz")
