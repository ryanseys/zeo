...
__END__
#@ stderr
core/string/str_method_nil_arg_no_segv.rb:19:in 'String#count': wrong number of arguments (given 0, expected 1+) (ArgumentError)
	from core/string/str_method_nil_arg_no_segv.rb:19:in '<main>'
#@ exit 1
