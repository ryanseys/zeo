...
__END__
#@ stderr
compiler/fusion/string_split_inline_arg_gc_root.rb:7:in 'Object#churn_gc': undefined method '<=' for nil (NoMethodError)
	from compiler/fusion/string_split_inline_arg_gc_root.rb:43:in '<main>'
#@ exit 1
