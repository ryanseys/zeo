...
__END__
#@ stderr
lang/misc/sp_net_poll_persistent.rb:10:in '<module:Net>': undefined method 'ffi_func' for module Net (NoMethodError)
	from lang/misc/sp_net_poll_persistent.rb:9:in '<main>'
#@ exit 1
