...
__END__
#@ stderr
lang/misc/sp_net_write_partial.rb:9:in '<module:Net>': undefined method 'ffi_func' for module Net (NoMethodError)
	from lang/misc/sp_net_write_partial.rb:8:in '<main>'
#@ exit 1
