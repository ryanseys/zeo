...
"before"
#@ stderr
lang/exceptions/uncaught_exception_message.rb:5:in 'Object#boom': undefined method 'length' for nil (NoMethodError)
	from lang/exceptions/uncaught_exception_message.rb:15:in '<main>'
#@ exit 1
