...
__END__
#@ stderr
lang/modules/param_include_body_widen.rb:16:in 'Object#consume': undefined method 'include?' for nil (NoMethodError)
	from lang/modules/param_include_body_widen.rb:24:in '<main>'
#@ exit 1
